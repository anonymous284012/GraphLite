...
class MultiSelectDialogField<V> extends FormField<List<V>> {
  ...
  final bool isChipsDisplayEnabled;
  ...
  MultiSelectDialogField({
    ...
    this.title,
    this.isChipsDisplayEnabled = false,
    this.buttonText,
    this.buttonIcon,
    this.listType,
    this.isOpen,
    ...
    this.key,
            ...
            builder: (FormFieldState<List<V>> state) {
              _MultiSelectDialogFieldView<V> field = _MultiSelectDialogFieldView<V>(
                ...
                items: items,
                isOpen: isOpen,
                isChipsDisplayEnabled: isChipsDisplayEnabled,
...
class _MultiSelectDialogFieldView<V> extends StatefulWidget {
  ...
  _MultiSelectDialogFieldView._withState(
      ...
      : items = field.items,
        ...
        isOpen = field.isOpen,
        isChipsDisplayEnabled = field.isChipsDisplayEnabled,
...
class __MultiSelectDialogFieldViewState<V> extends State<_MultiSelectDialogFieldView<V>> {
  ...
  @override
  void didUpdateWidget(_MultiSelectDialogFieldView oldWidget) {
  ...
  Widget _buildInheritedChipDisplay() {
    ...
    if (widget.chipDisplay != null) {
      ...
      if (widget.isChipsDisplayEnabled) {
